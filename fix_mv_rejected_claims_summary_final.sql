-- ==========================================================================================================
-- FIX: mv_rejected_claims_summary - FINAL CORRECTED VERSION
-- ==========================================================================================================
-- 
-- Purpose: Fix duplicate key violations in mv_rejected_claims_summary
-- Issue: CTE was filtering out all data, causing syntax and logic errors
-- Solution: Restructure to handle claim lifecycle stages properly
-- 
-- KEY INSIGHT: This MV should only show activities that have rejection data
-- But the CTE should not filter out activities - the main query should do the filtering
-- ==========================================================================================================
...
-- ==========================================================================================================
-- STEP 2: Create fixed materialized view with proper lifecycle handling
-- ==========================================================================================================
...
-- Test 4: Check different rejection types
SELECT 
  rejection_type,
  COUNT(*) as count
FROM claims.mv_rejected_claims_summary

...
class IngestionPersistServiceSubmissionTest {
    ...
    void setUp() {
        ...
        var obs = List.of(new ObservationDTO("Result","A1C","5","Date"));
        ...
        var dx = List.of(new DiagnosisDTO("Principal","E78.5"));

        var claim = new SubmissionClaimDTO(
                "C-1","IDP-1","MEM-1","PAYER1","PROV1","784-1993-9685935-9",
                new BigDecimal("553.94"), new BigDecimal("67.96"), new BigDecimal("485.98"),
                enc, dx, List.of(act),
                null, null
        );

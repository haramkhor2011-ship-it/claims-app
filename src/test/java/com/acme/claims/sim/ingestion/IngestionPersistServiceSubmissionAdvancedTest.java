...
class IngestionPersistServiceSubmissionAdvancedTest {
    ...
    void setUp() {
        ...
        var obs1 = List.of(
                new ObservationDTO("Result","A1C","5","Date"),
                new ObservationDTO("Text","Description","Hemoglobin glycosylated A1C","Other")
        );
        ...
        var obs2 = List.of(new ObservationDTO("Result","BPS","120","Date"));
        ...
        var claim = new SubmissionClaimDTO(
                ...
                new BigDecimal("600.00"), new BigDecimal("50.00"), new BigDecimal("550.00"),
                enc, diagnoses, List.of(a1, a2), null, null
        );

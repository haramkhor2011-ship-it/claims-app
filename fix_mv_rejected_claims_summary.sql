-- ==========================================================================================================
-- FIX: mv_rejected_claims_summary - Apply Activity-Level Rejection Aggregation
-- ==========================================================================================================
-- 
...
-- Solution: Pre-aggregate rejection data per activity before joining to ensure one row per (claim_key_id, activity_id)
-- 
-- Analysis: This MV is for Rejected Claims Report - activity-level view showing only rejected activities
...
-- - Required: Activity-level rejection aggregation with latest status
-- ==========================================================================================================
...
-- ==========================================================================================================
-- STEP 2: Create fixed materialized view with activity-level rejection aggregation
-- ==========================================================================================================
...
-- 
-- CHANGES MADE:
-- 1. Added activity_rejection_agg CTE to pre-aggregate rejection data per activity
-- 2. Modified main query to use aggregated rejection data instead of direct JOINs
-- 3. Removed direct LEFT JOINs to remittance_claim and remittance_activity
-- 4. Added proper aggregation logic for rejection amounts, denial codes, and settlement dates
-- 5. Updated documentation comment to indicate fix applied
-- 6. Added WHERE clause to only include activities with rejection data
-- 
-- BENEFITS:
-- - Eliminates duplicate key violations on (claim_key_id, activity_id)
-- - Ensures one row per rejected activity with aggregated rejection data
-- - Maintains all original functionality and metrics
-- - Improves performance by reducing data duplication
-- - Follows activity-level rejection aggregation pattern for Rejected Claims Report
-- 
-- TESTING:
-- - Row count verification
-- - Duplicate detection
-- - Activity-level rejection aggregation verification
-- - Refresh testing
-- ==========================================================================================================
